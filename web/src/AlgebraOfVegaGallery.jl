...
@dynamicstruct struct AoVAppData
    ...
    curated_sections = [
        ...
        ("AoG: Statistical Analyses" => ["aog_density", "aog_density_faceted", "aog_density_ridgeline", "aog_ecdf", "aog_ecdf_grouped", "aog_histogram_basic", "aog_histogram", "aog_frequency", "aog_expectation", "aog_frequency_color", "aog_linear", "aog_smooth", "aog_linear_band", "aog_smooth_band"]),
        ...
        ("Uncertainty (tidybayes)" => ["pointinterval", "pointinterval_markers", "pointinterval_vertical", "halfeye", "gradient_interval", "lineribbon", "lineribbon_single_band", "lineribbon_grouped", "lineribbon_faceted", "lineribbon_overlay", "lineribbon_logscale", "ppc_overlay", "ribbon_only", "precomputed_lineribbon", "precomputed_lineribbon_grouped", "precomputed_pointinterval", "remap_precomputed_pointinterval_positional", "dotinterval", "raincloud"]),
