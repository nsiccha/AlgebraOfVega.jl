# title: VLines color mapping under auto_remap (bug)
# description: Same 2 scatter + VLines setup as aog_vlines_faceted_color, but wrapped in auto_remap_node. VLines' per-layer color=:vessel should survive the Julia-side _rebuild_layer pass AND the JS remapEncoding color override, but is currently clobbered.
